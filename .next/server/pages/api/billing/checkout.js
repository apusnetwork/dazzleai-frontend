...
async function handler(req, res) {
    try {
        ...
        const stripeRes = await _frontend_utils_axios__WEBPACK_IMPORTED_MODULE_0__/* ["default"].post */ .ZP.post("/api/stripe/create-checkout-session", req.body, {
            headers: {
