...
async function handler(req, res) {
    try {
        ...
        const stripeRes = await _frontend_utils_axios__WEBPACK_IMPORTED_MODULE_0__/* ["default"].post */ .ZP.post("/api/crypto/create-checkout-session", req.body, {
            headers: {
...
var __webpack_exports__ = __webpack_require__.X(0, [2378], () => (__webpack_exec__(3156)));
