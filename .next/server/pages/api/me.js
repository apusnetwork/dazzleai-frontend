...
/* harmony export */   "transformUserInfoResponse": () => (/* binding */ transformUserInfoResponse)
/* harmony export */ });
...
function transformUserInfoResponse(res) {
    return {
        ...res,
        id: res.user_id,
        referralCode: "",
...
var __webpack_exports__ = __webpack_require__.X(0, [2378], () => (__webpack_exec__(6149)));
